                    ...
                    <div className={this.props.style.footer__inner} >
                        <div className={this.props.style.footer__menu} >
                            <div className={this.props.style.footer__nav}>
                                <NavLink className={this.props.style.footer__logo} to={this.props.logo.adresse}>
                            ...
                            <nav className={this.state.menuPopap}>
                                {this.props.menuList.map(el => {
                                    return (
                                        <a className={this.props.style.footer__item} key={el.id} href={el.adresse}>{el.item}</a>
                                    )
                                })}
                            </nav>
                            ...
                            <div className={this.state.contactsPopap}>
                                <a href="tel:+79999998283" className={this.props.style.footer__number}>+7 (999) 999 - 82 - 83</a>
