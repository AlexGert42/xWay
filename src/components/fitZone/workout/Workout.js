            ...
            <div className="workout__promo">
              <div className="workout__promo_inner">
                ...
                <p className="workout__discription">
                  Тренировки на улице — это идеальный вид физической активности
                  в теплое время года. Сочетание эффективно составленной
                  тренировочной программы и возможностей, которые дает открытое
                  помещение (обилие кислорода, солнечные лучи и витамин D,
                  разнообразные локации) позволят Вам максимально быстро
                  получить желаемый результат.
                </p>
                <button
                  className="workout__king_btn"
        ...
        <section className="workout_advantage">
          <div className="container">
            <div className="workout_advantage__inner">
              <div className="workout_advantage__title">
                Преимущества заанятий Воркаутом
              </div>
              <div className="workout_advantage__list">
                <div className="workout_advantage__item">
                  <img
                    src={imgAdvantage1}
                    alt="img_1"
                    className="workout_advantage__img"
                  />
                  <p className="workout_advantage__subtitle">O2</p>
                  <p>
                    Выполняя упражнения на свежем воздухе, клетки организма
                    активно насыщаются кислородом, улучшается общее
                    самочувствие, внешний вид и обмен веществ.
                  </p>
                </div>
                <div className="workout_advantage__item">
                  <img
                    ...
                    className="workout_advantage__img"
                  />
                  <p className="workout_advantage__subtitle">РАЗНООБРАЗИЕ</p>
                  <p>
                    Разнообразный выбор упражнений. Воркаут тренирует все группы
                    мышц рук, ног, пресса. При чередовании упражнений можно
                    обрести красивый рельеф и выносливое тело.
                  </p>
                </div>
                <div className="workout_advantage__item">
                  <img
                    ...
                    className="workout_advantage__img"
                  />
                  <p className="workout_advantage__subtitle">УНИВЕРСАЛЬНОСТЬ</p>
                  <p>
                    Заниматься могут девушки и парни, дети, люди пожилого
                    возраста или с ограниченными возможностями. Не нужно быть в
                    отличной физической форме, иметь особые навыки и умения.
                  </p>
                </div>
                <div className="workout_advantage__item">
                  <img
                    ...
                    className="workout_advantage__img"
                  />
                  <p className="workout_advantage__subtitle">БЕЗОПАСНОСТЬ</p>
                  <p>
                    Травматичность сведена к минимуму, потому что все упражнения
                    делаются без дополнительных отягощений, под контролем
                ...
                <div className="workout_advantage__item">
                  ...
                  <p>
                    Систематичность и правильное питание помогут быстро достичь
                    видимых результатов, красивого и здорового тела.
                  </p>
                </div>
              </div>
            </div>
        ...
        <section className="workout_prices">
          <div className="container">
            <div className="workout_prices__inner">
              <div className="workout_prices__title">
              ...
              <div className="workout_prices__cards">
                <div className="workout_card">
                  ...
                  <div className="workout_card__discription">
                    ...
                    <p className="workout_card__one_session">
                      1 ТРЕНИРОВКА 4500 ₽
                    </p>
                  </div>
                </div>
