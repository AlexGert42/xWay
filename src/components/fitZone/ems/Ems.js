        ...
        <section className="ems_res">
          <div className="ems_res__inner">
            ...
            <div className="ems_res__text">
              <p>Мышцы укрепляются и прорабатываются в буквальном смысле изнутри. Подобный тип занятий спортом благодаря электростимуляции позволяет тонизировать около 90% всех мышечных тканей организма.</p>
              <p>Во время тренировки работают только мышцы, нагрузка же на суставы не осуществляется. Благодаря этому, такой спорт прекрасно подойдёт тем людям, которые проходят период реабилитации после травм.</p>
              <p>Не требуется носить с собой спортивный костюм. Все предметы, необходимые для выполнения упражнений, будут предоставлены на месте.</p>
              <p>Персональные тренировки с тренером, который составляет программу занятий с учетом Ваших индивидуальных физических возможностей и целей.</p>
            </div>
          </div>
          <Carousel
