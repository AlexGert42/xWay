                        ...
                        <div className="container">
                            <div className="stretching__promo">
                                <div className="stretching__promo_inner">
                                    ...
                                    <p className="stretching__discription">Быстрая безболезненная растяжка и гибкость всего тела <br /> на тренажере «Бизон-вибро», добиваемся результатов уже <br /> после первого занятия!</p>
                                    <button className="stretching__king_btn" onClick={() => this.props.chengeStateModal(true)}>ПОСЕТИТЬ ПРОБНОЕ ЗАНЯТИЕ</button>
                                </div>
                            </div>
                        </div>
                    </section>
                    ...
                    <div className="container">
                        <div className="stretching_about__inner">
                            <div className="stretching_about__menu">
                                <h2 className={this.state.titles[0].title} onClick={this.chengeBlock} title="bms">BMS</h2>
                                <h2 className={this.state.titles[1].title} onClick={this.chengeBlock} title="pilates">Пилатес</h2>
                                <h2 className={this.state.titles[2].title} onClick={this.chengeBlock} title="yoga">Йога</h2>
                                <h2 className={this.state.titles[3].title} onClick={this.chengeBlock} title="aero">Аэростретчинг</h2>
                            </div>
                            <ul className="stretching_about__list">
                                <li className={this.state.blocks[0].block} >
                                    <div className="stretching_about__text">
                                        <p>
                                            Если вы хотите поработать над эстетикой тела, изящностью движений, гибкостью, а также улучшить состояние суставов и сухожилий, быстро сесть на шпагат без боли и получить +100 500 к сексуальности, то вам определенно подойдут наши тренировки по растяжке
                                            Инновационные БМС тренировки с использованием тренажера «Бизон-вибро» дают потрясающий результат в увеличении растяжки, скульптурировании тела и в реабилитации тела человека.
                                        </p>
                                        <p>
                                            Тренажер использует вибрацию с частотой, такой же,
                                            как в человеческом организме (20 — 32Гц). При передаче вибрации на мышцу, она начинает усиленно сокращаться и расслабляться, создавая эффект очень интенсивной тренировки.
                                        </p>
                                        <p>
                                            БМС тренировки помогают привести мышцы в тонус, снять отёчность, убрать мышечные зажимы, восстановиться после травм, а также осуществить свою давнюю мечту — сесть на шпагат в 5 раз быстрее без боли!
                                        </p>
                                    </div>
                                ...
                                <li className={this.state.blocks[1].block}>
                                    <div className="stretching_about__text">
                                        <p>
                                            Пилатес — это система физических упражнений, направленная на совершенствование тела через движение.
                                       </p>
                                        <p>
                                            Эта замечательная система упражнений, развитая Джозефом Пилатесом, укрепляет мышцы всего тела, развивает гибкость, улучшает координацию, здоровье и самочувствие.
                                            Жизнь — это Движение, а ПИЛАТЕС — это движение
                                            для Жизни! Пилатес каждый день помогает тысячам
                                            людей двигаться лучше, чувствовать себя лучше и выглядеть на все сто.
                                        </p>
                                        <p>

                                            Каждый из видов упражнений в пилатесе направлен на достижение определенного оздоровительного и эстетического результата для организма. Комплексы упражнений в пилатесе не являются однотипными,
                                            так как постоянно совершенствуются и комбинируются.
                                        </p>
                                    </div>
                                    <div className="stretching_about__vid">
                                ...
                                <li className={this.state.blocks[2].block}>
                                    <div className="stretching_about__text">
                                        ...
                                        <p>
                                            Поступательное движение к гармонии тела и ума через равномерное неагрессивное вытяжение одних частей тела
                                ...
                                <li className={this.state.blocks[3].block}>
                                    <div className="stretching_about__text">
                                        <p>
                                            Аэрострейчинг, является смесью йоги, растяжки и воздушной гимнастики. Занятия проходят в специальной материи, которая крепится в виде петли к потолку с помощью альпинистских карабинов. Чем-то это петля напоминает гамак, отсюда и второе название направления — йога в гамаках.
                                       </p>
                                        <p>
                ...
                <section className="stretching_prices">
                    <div className="container">
                        <div className="stretching_prices__inner">
                            <div className="stretching_prices__title">Наши абонементы и цены</div>
                            <div className="stretching_prices__cards">
                                <div className="stretching_card">
                                    ...
                                    <div className="stretching_card__discription">
                                        ...
                                        <p className="stretching_card__one_session">1 ТРЕНИРОВКА 4500 ₽</p>
                                    </div>
                                </div>
                                <div className="stretching_card">
                                    ...
                                    <div className="stretching_card__discription">
                                        ...
                                        <p className="stretching_card__one_session">1 ТРЕНИРОВКА 3825 ₽</p>
                                    </div>
                                </div>
                                <div className="stretching_card">
                                    ...
                                    <div className="stretching_card__discription">
                                        ...
                                        <p className="stretching_card__one_session">1 ТРЕНИРОВКА 3375 ₽</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <section className="stretching_advantage">
                    <div className="container">
                        <div className="stretching_advantage__inner">
                            <div className="stretching_advantage__title">Какой результат вы получите</div>
                            <div className="stretching_advantage__list">
                                <div className="stretching_advantage__item">
                                    <img src={imgAdvantage1} alt="img_1" className="stretching_advantage__img" />
                                    <p>Увеличение гибкости
                                    и подвижности
в суставах</p>
                                </div>
                                <div className="stretching_advantage__item">
                                    <img src={imgAdvantage2} alt="img_2" className="stretching_advantage__img" />
                                    <p>Избавление от болей любого характера</p>
                                </div>
                                <div className="stretching_advantage__item">
                                    <img src={imgAdvantage3} alt="img_3" className="stretching_advantage__img" />
                                    <p>Увеличение гибкости и подвижности в суставах</p>
                                </div>
                                <div className="stretching_advantage__item">
                                    <img src={imgAdvantage4} alt="img_4" className="stretching_advantage__img" />
                                    <p>Идеальная осанка
и красивый стройный силуэт</p>
                                </div>
                                <div className="stretching_advantage__item">
                                    <img src={imgAdvantage5} alt="img_5" className="stretching_advantage__img" />
