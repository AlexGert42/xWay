                        ...
                        <div className="container">
                            <div className="functional__promo">
                                <div className="functional__promo_inner">
                                    <h1 className="functional__title">ФУНКЦИОНАЛЬНЫЕ ТРЕНИРОВКИ</h1>
                                    ...
                                    <button className="functional__king_btn" onClick={() => this.props.chengeStateModal(true)}>ПОСЕТИТЬ ПРОБНОЕ ЗАНЯТИЕ</button>
                                </div>
                            </div>
                        </div>
                    </section>
                ...
                <section className="functional_advantage" >
                    <div className="container">
                        <div className="functional_advantage__inner">
                            <div className="functional_advantage__title">Преимущества занятий функциональным тренингом</div>
                            <div className="functional_advantage__list">
                                <div className="functional_advantage__item">
                                    <img src={imgAdvantage1} alt="img_1" className="functional_advantage__img" />
                                    <p className="functional_advantage__subtitle">
                                        МОЩНАЯ ПРОКАЧКА
                                    </p>
                                    <p>
                                        Равномерная нагрузка на все группы мышц и даже мышцы-стабилизаторы.
                                        Это возможно благодаря сложной биомеханике и разнообразию выполняемых упражнений.
                                    </p>
                                </div>
                                <div className="functional_advantage__item">
                                    <img src={imgAdvantage2} alt="img_2" className="functional_advantage__img" />
                                    <p className="functional_advantage__subtitle">
                                        РАЗНООБРАЗИЕ
                                    </p>
                                    <p>
                                ...
                                <div className="functional_advantage__item">
                                    <img src={imgAdvantage3} alt="img_3" className="functional_advantage__img" />
                                    <p className="functional_advantage__subtitle">
                                        СИЛА И СКОРОСТЬ
                                    </p>
                                    <p>
                                        Занятия «функционалкой» тренируют и развивают одновременно несколько физических качеств спортсмена. Среди них сила, скорость, гибкость, координация движений и аэробная выносливость.                                    </p>
                                </div>
                                <div className="functional_advantage__item">
                                    <img src={imgAdvantage4} alt="img_4" className="functional_advantage__img" />
                                    <p className="functional_advantage__subtitle">
                                        АТЛЕТИЧНОЕ ТЕЛО
                                    </p>
                                    <p>
                                ...
                                <div className="functional_advantage__item">
                                    <img src={imgAdvantage5} alt="img_5" className="functional_advantage__img" />
                                    <p className="functional_advantage__subtitle">
                                        ПОСТРЕАБИЛИТАЦИЯ
                                    </p>
                                    <p>
                                        Постреабилитация — специально разработанный тренировочный комплекс по восстановлению мышечной и нервной систем.
                ...
                <section className="functional_prices">
                    <div className="container">
                        <div className="functional_prices__inner">
                            <div className="functional_prices__title">Наши абонементы и цены</div>
                            <div className="functional_prices__cards">
                                <div className="functional_card">
                                    ...
                                    <div className="functional_card__discription">
                                        ...
                                        <p className="functional_card__one_session">1 ТРЕНИРОВКА 4500 ₽</p>
                                    </div>
                                </div>
                                <div className="functional_card">
                                    ...
                                    <div className="functional_card__discription">
                                        ...
                                        <p className="functional_card__one_session">1 ТРЕНИРОВКА 3825 ₽</p>
                                    </div>
                                </div>
                                <div className="functional_card">
                                    ...
                                    <div className="functional_card__discription">
                                        ...
                                        <p className="functional_card__one_session">1 ТРЕНИРОВКА 3375 ₽</p>
                                    </div>
                                </div>
                            </div>
                        </div>
